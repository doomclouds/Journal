...
- [2026-05-13-history-workbench-stale-selection-restore-mismatch-problem.md](./2026-05/2026-05-13-history-workbench-stale-selection-restore-mismatch-problem.md): 记录历史/同日年轮工作台 selected date、version detail、month-day 输入与旧 state 错配，可能显示旧内容或拼出错误恢复请求的前端竞态问题。
