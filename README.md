...
- Today Assistant 新增 `同日年轮` 入口，默认打开今天的 `MM-DD`。
...
- 年份详情可以查看历史 Markdown、raw material snippets、版本快照和既有 draft-only 恢复动作。

阶段 6B 不包含 AI 多年总结、纪念日管理、跨日期编辑、非今日确认、diff/rollback、Future Notes 或 item 级 provenance。
